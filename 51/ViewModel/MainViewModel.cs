...
public class MainViewModel : ReactiveObject
{
    ...
    public MainViewModel()
    {
        ...
        _tools[ToolEnum.Curve] = new CurveTool(_objects, MatrixVM);
        _tools[ToolEnum.Rect] = new RectTool(_objects, MatrixVM);
        _tools[ToolEnum.Circle] = new CircleTool(_objects, MatrixVM);
        _tools[ToolEnum.Oval] = new OvalTool(_objects, MatrixVM);
        _tools[ToolEnum.Text] = new TextTool(_objects, MatrixVM, TextInputVM);
        _tools[ToolEnum.Image] = new ImageTool(_objects, MatrixVM);
    ...
    private void ExportPng()
    {
        ...
        CanvasViewModel vm = new(_objects, MatrixVM);
